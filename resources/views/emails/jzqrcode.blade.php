...
<head>
    ...
    <style type="text/css">
        ...
        body{margin: 0; padding: 0; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; background-color: rgb(235,235,235);}
                                        ...
                                        <tr>
                                            <td style='width:104px;'>
                                                <a href target='_blank'>
                                                    <img alt='蒋申后援会logo' height='128' src='https://lg-bus1kzl6-1251693677.file.myqcloud.com/debbie/callilogo.png' style='border:0;display:block;font-size:13px;height:128px;outline:none;text-decoration:none;width:100%;' width='104' />
                                                </a>
                                            </td>
                                        </tr>
                                        </tbody>
                            ...
                            <tr>
                                <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                                    <div style='color:#feae39;font-family:Open Sans, Arial, sans-serif;font-size:18px;line-height:20px;text-align:center;'>
                                        这是你的兑奖二维码，当天你可以在现场领取到：<br/>饮料自选一杯，限定杯套一个，毕业透扇一把，抽选一个钥匙扣立牌，手幅两张，以及现场限定应援物资一份；可租借灯牌一个。
                                    </div>
                                </td>
                            </tr>
                        </table>
                                    ...
                                    <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='border-collapse:collapse;border-spacing:0px;'>
                                        ...
                                        <tr>
                                            <td style='width:200px;'>
                                                <img alt='QRcode' height='260' src='https://lg-bus1kzl6-1251693677.cos.ap-shanghai.myqcloud.com/debbie/web/qrcode/{{ $args['qrcode'] }}.png' style='border:0;display:block;font-size:13px;height:260px;outline:none;text-decoration:none;width:100%;' width='200' />
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                            ...
                            <tr>
                                <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                                    <div style='color:#999999;font-family:Open Sans, Arial, sans-serif;font-size:15px;line-height:22px;text-align:center;'>
                                        如果二维码图片无法加载，也可以点击<a href="https://lg-bus1kzl6-1251693677.cos.ap-shanghai.myqcloud.com/debbie/web/qrcode/{{ $args['qrcode'] }}.png">此链接获取图片</a>
                                    </div>
                                </td>
                                <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                                    <div style='color:#999999;font-family:Open Sans, Arial, sans-serif;font-size:15px;line-height:22px;text-align:center;'>
                                        当天现场前来领取的人可能较多。疫情之下，为了减少聚集，提高核验身份的效率，请提前截图或储存此二维码，作为现场领取jz奖励应援礼包的（最高优先级）有效凭证，切勿泄露给他人！遗失可向后援会机器人申请重发。
                                    </div>
                                </td>
                            </tr>
                        </table>
