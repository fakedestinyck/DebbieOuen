...
{{--                                    <img src="{{ "https:".$veach["pic"] }}" alt="封面图" media-simple="true">--}}
    ...
    <section class="counters1 counters cid-rcfIDKQ3Xf" id="counters1-f" data-rv-view="30">
        ...
        <div class="container">
            ...
            <div class="media-container-row pt-5">
                <div>
                    <div class="align-center" id="video" style="width: 360px; height: 640px;"></div>
                </div>
            </div>
...
//                }
            ...
            video: [
                ['https://qqbot-1251693677.file.myqcloud.com/5ed52106c2d61916473673881d238be7/5cca4906/douyin/video_name.mp4', 'video/mp4', '中文标清', 0],
            ]
            /*video:[
