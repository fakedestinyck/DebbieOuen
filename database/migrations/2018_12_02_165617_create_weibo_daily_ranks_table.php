...
class CreateWeiboDailyRanksTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('weibo_daily_ranks', function (Blueprint $table) {
            ...
            $table->unsignedTinyInteger('myTotalRank')->nullable();
            ...
            $table->unsignedTinyInteger('readingRank')->nullable();
            ...
            $table->unsignedTinyInteger('interactionRank')->nullable();
            ...
            $table->unsignedTinyInteger('impactRank')->nullable();
            ...
            $table->unsignedTinyInteger('flowerRank')->nullable();
